...
<%
	FBoardVO board = (FBoardVO)request.getAttribute("board");
          ...
          <div class="block">
            <div class="product-list">  	
                <table class="table">
                  ...
                  <tbody>
                  <form method="post" action="/web/updateFBoard.do">
            	...
            	<a href="/web/deleteFBoard.do?seq=<%=board.getSeq() %>" class="btn btn-main pull-right">글삭제하기</a>
