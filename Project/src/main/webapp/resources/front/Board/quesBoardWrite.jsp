...
<section class="page-header">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="content">
               <h1 class="page-name">질문 게시판 글쓰기</h1>
               <ol class="breadcrumb">
                  <li><a href="/web/resources/index.jsp">Home</a></li>
...
<section class="page-header">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="content">
               <form id="contact-form" method="post" action="/web/insertQBoard.do" role="form">
               	  <input type="hidden" value="<%=id%>" name="id">
                  <div class="form-group">
                     <input type="text" placeholder="Your Nickname" class="form-control" name="nickname" id="name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     <textarea rows="6" placeholder="Content" class="form-control" name="content" id="message"></textarea>   
                  </div>
