...
<%
	List<QBoardVO> boardList=(List)request.getAttribute("qboardList");
%>
<!DOCTYPE html>
<html lang="ko">
<head>
            ...
            <div class="product-list">
              <form method="post">
                <table class="table">
                  ...
                  <tbody>
                  <%for (QBoardVO vo : boardList)  {%>
                  <tr>
                   	<td><%=vo.getSeq() %></td>
                     <td><%=vo.getNickname() %></td>
                     <td><a href="getQBoard.do?seq=<%=vo.getSeq()%>"><%=vo.getSubject() %></a></td>
                     <td><%=vo.getContent() %></td>
                     <td><%=vo.getDate() %></td> 
                  </tr>
                  <% } %>
