...
<section class="page-header">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="content">
               <h1 class="page-name">자유 게시판 글쓰기</h1>
               <ol class="breadcrumb">
...
<section class="page-header">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="content">
               <form id="contact-form" method="post" action="/web/insertFBoard.do" role="form">
                  ...
                  <div class="form-group">
                     <textarea rows="6" placeholder="Message" class="form-control" name="content" id="message"></textarea>   
                  </div>
