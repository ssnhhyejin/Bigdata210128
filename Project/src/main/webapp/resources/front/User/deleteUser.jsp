        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="block">
            <div class="product-list">  	
                <table class="table">
                  <form method="post" action="/web/deleteUser.do">
                  	<input type="hidden" value="<%=id%>" name="id">
                    <tr align="center">
                      <th class="">Password</th>
                      <td><input class="form-control" type="text" placeholder="비밀번호를 입력하세요" name="password"></td>
                    </tr>
                    <%-- <tr align="center">
                      <th class="">Password Confirm</th>
                      <td><input class="form-control" type="text" name="passwordConfirm"></td>
                     </tr>
 --%>                </table>
                <button type="submit" class="btn btn-main pull-right">회원 탈퇴</button>
                </form>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="/web/resources/index.jsp" class="btn btn-main pull-right">돌아가기</a>
            </div>
          </div>
        </div>
      </div>
